...
export class FACTUR_X_MINIMUM_urn_un_unece_uncefact_data_standard_ReusableAggregateBusinessInformationEntity_100 {
    public constructor(props?: FACTUR_X_MINIMUM_urn_un_unece_uncefact_data_standard_ReusableAggregateBusinessInformationEntity_100) {
        this["@class"] = ".FACTUR_X_MINIMUM_urn_un_unece_uncefact_data_standard_ReusableAggregateBusinessInformationEntity_100";
    }
}
...
export class ExchangedDocumentContextType {
    ...
    public constructor(props?: ExchangedDocumentContextType) {
        ...
        if (props) {
        	...
        	this.BusinessProcessSpecifiedDocumentContextParameter = (props.BusinessProcessSpecifiedDocumentContextParameter) ? new DocumentContextParameterType(props.BusinessProcessSpecifiedDocumentContextParameter): undefined;
        	this.GuidelineSpecifiedDocumentContextParameter = (props.GuidelineSpecifiedDocumentContextParameter) ? new DocumentContextParameterType(props.GuidelineSpecifiedDocumentContextParameter): undefined;
        }
    }
}
...
export class HeaderTradeAgreementType {
    ...
    public constructor(props?: HeaderTradeAgreementType) {
        ...
        if (props) {
        	...
        	this.BuyerOrderReferencedDocument = (props.BuyerOrderReferencedDocument) ? new ReferencedDocumentType(props.BuyerOrderReferencedDocument): undefined;
        }
    }
}
...
export class HeaderTradeSettlementType {
    ...
    public constructor(props?: HeaderTradeSettlementType) {
        ...
        if (props) {
        	...
        	this.SpecifiedTradeSettlementHeaderMonetarySummation = (props.SpecifiedTradeSettlementHeaderMonetarySummation) ? new TradeSettlementHeaderMonetarySummationType(props.SpecifiedTradeSettlementHeaderMonetarySummation): undefined;
        }
    }
}
...
export class SupplyChainTradeTransactionType {
    ...
    public constructor(props?: SupplyChainTradeTransactionType) {
        ...
        if (props) {
        	...
        	this.ApplicableHeaderTradeAgreement = (props.ApplicableHeaderTradeAgreement) ? new HeaderTradeAgreementType(props.ApplicableHeaderTradeAgreement): undefined;
        	this.ApplicableHeaderTradeDelivery = (props.ApplicableHeaderTradeDelivery) ? new HeaderTradeDeliveryType(props.ApplicableHeaderTradeDelivery): undefined;
        	this.ApplicableHeaderTradeSettlement = (props.ApplicableHeaderTradeSettlement) ? new HeaderTradeSettlementType(props.ApplicableHeaderTradeSettlement): undefined;
        }
    }
}
...
export class TradePartyType {
    ...
    public constructor(props?: TradePartyType) {
        ...
        if (props) {
        	...
        	this.SpecifiedLegalOrganization = (props.SpecifiedLegalOrganization) ? new LegalOrganizationType(props.SpecifiedLegalOrganization): undefined;
        	this.PostalTradeAddress = (props.PostalTradeAddress) ? new TradeAddressType(props.PostalTradeAddress): undefined;
        	this.SpecifiedTaxRegistration = props.SpecifiedTaxRegistration?.map(o => new TaxRegistrationType(o));
        }
    }
}
