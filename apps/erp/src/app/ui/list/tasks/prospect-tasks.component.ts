...
import { ProspectListPartsFragment } from '@erpjs/api-interfaces';

@Component({
  selector: 'erp-prospect-tasks',
  template: `
      <clr-tabs>
          <clr-tab>
          ...
          <clr-tab>
              ...
              <clr-tab-content *clrIfActive>
                  <erp-edit-prospect-task [prospect]="prospect" (selectedTaskChanged)="selectedTaskChanged($event)"></erp-edit-prospect-task>
              </clr-tab-content>
          </clr-tab>
      </clr-tabs>
  `,
...
export class ProspectTasksComponent extends TasksComponent {
