...
podlet.css({ value: "http://localhost:7100/build/dist/main.css" });

// All css and js files in the build folder should be added to the podlet definition.
podlet.js({ value: "http://localhost:7100/build/dist/index.js", defer: true, type: "module" });
...
app.get(podlet.content(), (req, res) => {
  res.status(200).podiumSend('<div id="admin"></div>');
});
