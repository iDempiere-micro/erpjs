...
# Welcome to EolERP Storybook
This is the Storybook code of [EolERP](https://github.com/iDempiere-micro/erpjs/wiki), the headless serverless ERP and CRM for the cloud
...
We use Storybook to build our components, to test them first, to communicate about them between business users, UX and developers.
