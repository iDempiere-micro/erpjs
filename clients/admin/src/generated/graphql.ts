...
export type SaveAccountingSchemeMutation = (
  { __typename?: 'Mutation' }
  & { saveAccountingScheme: (
    { __typename?: 'AccountingScheme' }
    & Pick<AccountingScheme, 'id'>
  ) }
);
...
export type CustomersByArgsQuery = (
  { __typename?: 'Query' }
  & { customersByArgs: Array<(
    { __typename?: 'Customer' }
    & Pick<Customer, 'id'>
  )> }
);
...
export type SaveCustomerGroupMutation = (
  { __typename?: 'Mutation' }
  & { saveCustomerGroup: (
    { __typename?: 'CustomerGroup' }
    & Pick<CustomerGroup, 'id'>
  ) }
);
...
export type SaveFactoringContractMutation = (
  { __typename?: 'Mutation' }
  & { saveFactoringContract: (
    { __typename?: 'FactoringContract' }
    & Pick<FactoringContract, 'id'>
  ) }
);
...
export type SaveFactoringProviderMutation = (
  { __typename?: 'Mutation' }
  & { saveFactoringProvider: (
    { __typename?: 'FactoringProvider' }
    & Pick<FactoringProvider, 'id'>
  ) }
);
...
export type CreateMonthlyInvoiceMutation = (
  { __typename?: 'Mutation' }
  & { createMonthlyInvoice: Array<(
    { __typename?: 'SalesInvoice' }
...
export type SaveSalesInvoiceMutation = (
  { __typename?: 'Mutation' }
  & { saveSalesInvoice: (
    { __typename?: 'SalesInvoice' }
    & Pick<SalesInvoice, 'id'>
...
export type FactoringProvidersForInvoiceQuery = (
  { __typename?: 'Query' }
...
export type SalesInvoicesInTimeQuery = (
  { __typename?: 'Query' }
  & { salesInvoicesReport: Array<(
    { __typename?: 'SalesInvoicesInTime' }
    & Pick<SalesInvoicesInTime, 'group' | 'date' | 'value'>
  )> }
);

export type AccountingSchemeDetailPartsFragment = (
  { __typename?: 'AccountingScheme' }
  & Pick<AccountingScheme, 'id' | 'displayName'>
  & { currency: (
    { __typename?: 'Currency' }
    & Pick<Currency, 'id' | 'isoCode' | 'displayName'>
  ) }
);

export type AccountingSchemeListPartsFragment = (
  { __typename?: 'AccountingScheme' }
  & Pick<AccountingScheme, 'id' | 'displayName'>
  & { currency: (
    { __typename?: 'Currency' }
...
export type AccountingSchemeByIdQuery = (
  { __typename?: 'Query' }
  & { accountingScheme: (
    { __typename?: 'AccountingScheme' }
...
export type AccountingSchemesQuery = (
  { __typename?: 'Query' }
...
export type AddressListPartsFragment = (
  { __typename?: 'Address' }
  & Pick<Address, 'id' | 'city' | 'line1' | 'zipCode'>
  & { country: (
    { __typename?: 'Country' }
...
export type AttachmentListPartsFragment = (
  { __typename?: 'Attachment' }
  & Pick<Attachment, 'id' | 'displayName' | 'isFolder' | 'size' | 'lastModified'>
);
...
export type AttachmentByIdQuery = (
  { __typename?: 'Query' }
  & { attachment: (
    { __typename?: 'Attachment' }
    & AttachmentListPartsFragment
...
export type BankAccountDetailPartsFragment = (
  { __typename?: 'BankAccount' }
  & Pick<BankAccount, 'id' | 'displayName' | 'bankAccountCustomerPrintableNumber' | 'iban' | 'swift'>
  & { bank: (
    { __typename?: 'Bank' }
    & BankListPartsFragment
  ) }
);
...
export type BankDetailPartsFragment = (
  { __typename?: 'Bank' }
  & Pick<Bank, 'id' | 'displayName' | 'bankIdentifierCode'>
);

export type BankListPartsFragment = (
  { __typename?: 'Bank' }
  & Pick<Bank, 'id' | 'displayName' | 'bankIdentifierCode'>
);
...
export type CountryDetailPartsFragment = (
  { __typename?: 'Country' }
  & Pick<Country, 'id' | 'displayName' | 'isoCode'>
);

export type CountryListPartsFragment = (
  { __typename?: 'Country' }
  & Pick<Country, 'id' | 'displayName' | 'isoCode'>
);
...
export type CurrencyDetailPartsFragment = (
  { __typename?: 'Currency' }
...
export type CustomerDetailPartsFragment = (
  { __typename?: 'Customer' }
  & Pick<Customer, 'id' | 'legalName' | 'displayName' | 'vatNumber' | 'idNumber' | 'invoicingEmail' | 'note' | 'www' | 'publicNote'>
  & { legalAddress: (
    { __typename?: 'Address' }
...
export type CustomerListPartsFragment = (
  { __typename?: 'Customer' }
  & Pick<Customer, 'id' | 'legalName' | 'displayName' | 'vatNumber' | 'invoicingEmail' | 'note'>
  & { legalAddress: (
    { __typename?: 'Address' }
    & AddressListPartsFragment
  ), address?: Maybe<(
...
export type CustomerPriceListPartsFragment = (
  { __typename?: 'CustomerPriceList' }
  & Pick<CustomerPriceList, 'id' | 'displayName' | 'validFrom' | 'validTo'>
  & { productPrices?: Maybe<Array<(
    { __typename?: 'CustomerProductPrice' }
    & CustomerProductPriceListPartsFragment
  )>> }
);

export type CustomerProductPriceListPartsFragment = (
  { __typename?: 'CustomerProductPrice' }
  & Pick<CustomerProductPrice, 'id' | 'sellingPrice'>
  & { product: (
    { __typename?: 'Product' }
...
export type CustomerGroupDetailPartsFragment = (
  { __typename?: 'CustomerGroup' }
  & Pick<CustomerGroup, 'id' | 'displayName'>
  & { customers?: Maybe<Array<(
    { __typename?: 'Customer' }
    & CustomerListPartsFragment
  )>>, customerPriceLists?: Maybe<Array<(
    { __typename?: 'CustomerPriceList' }
    & CustomerPriceListPartsFragment
  )>> }
);

export type CustomerGroupListPartsFragment = (
  { __typename?: 'CustomerGroup' }
  & Pick<CustomerGroup, 'id' | 'displayName'>
);
...
export type CustomerGroupByIdQuery = (
  { __typename?: 'Query' }
  & { customerGroup: (
    { __typename?: 'CustomerGroup' }
    & CustomerGroupDetailPartsFragment
...
export type FactoringContractDetailPartsFragment = (
  { __typename?: 'FactoringContract' }
  & Pick<FactoringContract, 'id' | 'invoicePrintNote'>
  & { customer: (
    { __typename?: 'Customer' }
    & CustomerListPartsFragment
  ), organization: (
...
export type FactoringContractListPartsFragment = (
  { __typename?: 'FactoringContract' }
  & Pick<FactoringContract, 'id' | 'invoicePrintNote'>
  & { customer: (
    { __typename?: 'Customer' }
...
export type FactoringContractByIdQuery = (
  { __typename?: 'Query' }
  & { factoringContract: (
    { __typename?: 'FactoringContract' }
...
export type FactoringContractsQuery = (
  { __typename?: 'Query' }
...
export type FactoringProviderDetailPartsFragment = (
  { __typename?: 'FactoringProvider' }
  & Pick<FactoringProvider, 'id' | 'displayName' | 'legalName' | 'contact'>
  & { bankAccount: (
    { __typename?: 'BankAccount' }
...
export type FactoringProviderListPartsFragment = (
  { __typename?: 'FactoringProvider' }
  & Pick<FactoringProvider, 'contact' | 'displayName' | 'id' | 'legalName'>
);
...
export type FactoringProviderByIdQuery = (
  { __typename?: 'Query' }
  & { factoringProvider: (
    { __typename?: 'FactoringProvider' }
...
export type FactoringProvidersQuery = (
  { __typename?: 'Query' }
...
export type MailSentFromQuery = (
  { __typename?: 'Query' }
  & Pick<Query, 'mailSentFrom'>
);

export type OrganizationDetailPartsFragment = (
  { __typename?: 'Organization' }
  & Pick<Organization, 'id' | 'displayName' | 'legalName' | 'registration' | 'contact' | 'idNumber' | 'vatNumber'>
  & { legalAddress: (
    { __typename?: 'Address' }
    & AddressListPartsFragment
  ), bankAccount: (
    ...
    { __typename?: 'DocumentNumberSequence' }
    & Pick<DocumentNumberSequence, 'current'>
  ) }
);

export type OrganizationListPartsFragment = (
  { __typename?: 'Organization' }
  & Pick<Organization, 'contact' | 'displayName' | 'id' | 'idNumber' | 'legalName' | 'registration' | 'vatNumber'>
);
...
export type ProductDetailPartsFragment = (
  { __typename?: 'Product' }
  & Pick<Product, 'id' | 'displayName' | 'sku'>
  & { defaultUoM?: Maybe<(
    { __typename?: 'UnitOfMeasurement' }
    & UnitOfMeasurementDetailPartsFragment
  )> }
);

export type ProductListPartsFragment = (
  { __typename?: 'Product' }
  & Pick<Product, 'id' | 'sku' | 'displayName'>
);
...
export type SalesInvoiceDetailPartsFragment = (
  { __typename?: 'SalesInvoice' }
  & Pick<SalesInvoice, 'documentNo' | 'dueDate' | 'grandTotal' | 'grandTotalAccountingSchemeCurrency' | 'id' | 'isActive' | 'isCalculated' | 'isCurrent' | 'isDraft' | 'issuedOn' | 'paymentTermInDays' | 'printDate' | 'printed' | 'printError' | 'printLanguageIsoCode' | 'reverseCharge' | 'totalLines' | 'totalLinesAccountingSchemeCurrency' | 'transactionDate'>
  & { currency: (
    { __typename?: 'Currency' }
    & CurrencyListPartsFragment
  ), customer: (
    ...
    { __typename?: 'SalesInvoiceVat' }
    & SalesInvoiceVatDetailPartsFragment
...
export type SalesInvoiceListPartsFragment = (
  { __typename?: 'SalesInvoice' }
  & Pick<SalesInvoice, 'id' | 'documentNo' | 'grandTotalAccountingSchemeCurrency'>
);
...
export type SalesInvoiceLineDetailPartsFragment = (
  { __typename?: 'SalesInvoiceLine' }
  & Pick<SalesInvoiceLine, 'id' | 'lineOrder' | 'linePrice' | 'narration' | 'quantity'>
  & { product: (
    { __typename?: 'Product' }
    & Pick<Product, 'id'>
  ) }
...
export type SalesInvoiceVatDetailPartsFragment = (
  { __typename?: 'SalesInvoiceVat' }
  & Pick<SalesInvoiceVat, 'id' | 'vatRatePercent' | 'vatTotal' | 'vatTotalAccountingSchemeCurrency' | 'vatTotalAccountingSchemeCurrencyRaw' | 'vatTotalRaw'>
);
...
export type UnitOfMeasurementDetailPartsFragment = (
  { __typename?: 'UnitOfMeasurement' }
  & Pick<UnitOfMeasurement, 'id' | 'displayName'>
);
...
export type MenuQuery = (
  ...
  & { menu: Array<(
    { __typename?: 'Menu' }
    & MenuListPartsFragment
  )> }
);

export type MenuListPartsFragment = (
  { __typename?: 'Menu' }
  & Pick<Menu, 'id' | 'displayName'>
  & { items: Array<(
    { __typename?: 'MenuItem' }
    & MenuItemListPartsFragment
  )> }
);

export type MenuItemListPartsFragment = (
  { __typename?: 'MenuItem' }
  & Pick<MenuItem, 'id' | 'to' | 'displayName'>
);
