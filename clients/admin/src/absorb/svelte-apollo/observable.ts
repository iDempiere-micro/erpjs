...
export type ReadableQuery<TData> = ReadableResult<TData> & ObservableQueryExtensions<TData>;

export function observableQueryToReadable<TData = unknown, TVariables = unknown>(
