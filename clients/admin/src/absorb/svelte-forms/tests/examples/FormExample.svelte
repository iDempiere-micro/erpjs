...
<form>
    ...
    <input id="email" type="email" bind:value={email} class:valid={$loginForm.fields.email.valid} />
    ...
    <button on:click|preventDefault={() => loginForm.validate()}> Validate form </button>
